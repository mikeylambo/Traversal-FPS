...
export function createTraversalMovingPlatformModel(options: ProceduralModelOptions = {}): THREE.Group {
  ...
  root.userData.materialPipeline = {"schemaVersion": 1, "status": "proceed", "registry": "/workspace/scratch/d1c5d8f30fba/img2threejs/docs/materials/material-reference.json", "analysisArtifact": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-analysis.json", "targetThreshold": 0.7, "unresolvedNotObservedMaterials": [], "regions": [{"componentId": "deck-shell", "regionId": "shell-white-coating", "specMaterialId": "shell-white", "profileId": "coating.painted-metal", "status": "proceed"}, {"componentId": "undercarriage", "regionId": "graphite-coating", "specMaterialId": "graphite", "profileId": "coating.painted-metal", "status": "proceed"}, {"componentId": "emitter-cyan", "regionId": "cyan-emitter-lens", "specMaterialId": "emitter-cyan", "profileId": "plastic.glossy", "status": "proceed"}, {"componentId": "corner-cap-array", "regionId": "dark-machined-hardware", "specMaterialId": "dark-detail", "profileId": "metal.steel-brushed", "status": "proceed"}], "controlledViewsRequired": ["albedo-unlit", "environment-reflection", "grazing", "neutral-studio", "reference-beauty"]};
  root.userData.materialReferenceRegistry = "/workspace/scratch/d1c5d8f30fba/img2threejs/docs/materials/material-reference.json";

  const materialMap: Record<string, THREE.Material> = {};
  materialMap["shell-white"] = createSculptMaterial(
    "shell-white",
    {"id": "shell-white", "name": "Cool white coated shell", "type": "physical", "shaderModel": "MeshPhysicalMaterial / PBR approximation", "qualityTier": "hero", "baseColor": "#EBEFF0", "color": "#EBEFF0", "albedo": {"dominant": "#DDDCE3", "secondary": ["#1C2227", "#D4D3DA", "#EEEEF2"], "samplingNotes": "Reference-derived from foreground pixels; de-lit to reduce baked shadows/highlights.", "map": {"path": "./public/textures/platform/shell-white_albedo.png", "url": "/textures/platform/shell-white_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}}, "colorVariation": {"palette": ["#DDDCE3", "#1C2227", "#D4D3DA", "#EEEEF2", "#A19FA5"], "pattern": "reference-derived pixel palette", "amplitude": 0.35, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2, 2], "anisotropy": 8, "texelDensityIntent": "Stable object-space density; no stretching under runtime platform scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.52, "role": "reference-derived broad albedo and height breakup"}, {"id": "meso", "frequency": 14.0, "amplitude": 0.256, "role": "reference-derived cracks, ridges, pores, grain, or leaf clusters"}, {"id": "micro", "frequency": 72.0, "amplitude": 0.115, "role": "reference-derived micro highlight breakup under grazing light"}], "roughness": {"base": 0.45, "variation": 0.05, "map": {"path": "./public/textures/platform/shell-white_roughness.png", "url": "/textures/platform/shell-white_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "localResponse": "reference-derived roughness estimate; cavities and textured zones trend rougher, bright highlights trend smoother"}, "metalness": {"base": 0.0, "variation": 0.04}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.186, "map": {"path": "./public/textures/platform/shell-white_normal.png", "url": "/textures/platform/shell-white_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "heightSource": {"path": "./public/textures/platform/shell-white_height.png", "url": "/textures/platform/shell-white_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.011, "map": {"path": "./public/textures/platform/shell-white_height.png", "url": "/textures/platform/shell-white_height.png", "channel": "height", "source": "reference-pixel-extraction"}}, "displacement": {"pattern": "none", "amplitude": 0, "scale": 1, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.38, "contactShadowBias": 0.35, "map": {"path": "./public/textures/platform/shell-white_ao.png", "url": "/textures/platform/shell-white_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}, "notes": "Reference-derived cavity estimate from local height minima; verify against grazing-light screenshot."}, "wear": {"edgeWear": 0.08, "scratches": ["sparse cool-gray hairlines at corners"], "chips": []}, "dirt": {"amount": 0.025, "cavityBias": 0.72, "color": "#111820"}, "localOverrides": [{"id": "traversal-mark", "type": "decal", "region": "front fascia center", "baseColor": "#101820", "roughness": 0.42, "evidenceRefs": ["front-fascia"]}, {"id": "sparse-edge-wear", "type": "scratch-cluster", "region": "deck perimeter and corners", "baseColor": "#AEB8BC", "roughness": 0.68, "amplitude": 0.08, "evidenceRefs": ["top-deck"]}, {"id": "reference-pbr-pixel-evidence", "type": "material-map-evidence", "evidenceRefs": ["full-object"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Use generated maps as material evidence, then refine after browser screenshot comparison."}], "shaderNotes": ["Independent PBR channels come from reference evidence extraction.", "Keep wear restrained and cyan emission localized.", "Reference-derived maps are estimates from image pixels; verify with neutral, grazing, and reference-matched renders.", "Do not treat baked image shadows as final albedo; rerun extraction with a tighter material crop if highlights/shadows pollute the maps."], "notes": "Approved Traversal platform material family.", "finishClass": "brushed-steel", "texturePalette": ["#161C21", "#A8A9B0", "#DBDAE0", "#D4D3D8", "#BCBAC0"], "proceduralTexture": "brushed", "clearcoat": {"base": 0.75, "variation": 0.0}, "clearcoatRoughness": {"base": 0.12, "variation": 0.0}, "transmission": {"base": 0.0, "variation": 0.0}, "ior": {"base": 1.5, "value": 1.5, "variation": 0.0}, "envMapIntensity": 1.0, "anisotropy": {"base": 1.0}, "referencePbr": {"version": "1.0", "sourceImage": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/00-shell-white-coating.png", "extractor": "stage1_intake/extract_pbr_evidence.py", "method": "single-image pixel evidence with de-lighting estimate; not photogrammetry", "usable": true, "verdict": "pass", "confidence": 0.829, "estimatedFidelity": 0.829, "targetThreshold": 0.7, "hardLimit": "A single image cannot uniquely recover true albedo/roughness/normal/AO; maps are reference-derived estimates.", "maps": {"albedo": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-00-shell-white-coating/shell-white_albedo.png", "url": "shell-white_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-00-shell-white-coating/shell-white_roughness.png", "url": "shell-white_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-00-shell-white-coating/shell-white_height.png", "url": "shell-white_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-00-shell-white-coating/shell-white_normal.png", "url": "shell-white_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-00-shell-white-coating/shell-white_ao.png", "url": "shell-white_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "diagnostics": {"sourceWidth": 300, "sourceHeight": 88, "mapSize": 512, "cropBBoxPixels": {"x": 0, "y": 0, "width": 300, "height": 88}, "mask": {"backgroundColor": "#161B1F", "backgroundNoise": 24.249, "transparentPixelFraction": 0.0, "foregroundCoverage": 0.9955}, "mapStats": {"valueRange": 0.8386, "heightP90Gradient": 0.04646, "roughnessBase": 0.69, "roughnessVariation": 0.061, "normalStrength": 0.211, "blurRadius": 10}, "palette": ["#DEDCE3", "#1C2227", "#D4D3DA", "#EFEEF3", "#A19FA5"]}, "warnings": ["image is not clearly isolated from background; using most pixels as material evidence", "object/background separation is weak", "single-image inverse rendering cannot prove true physical PBR; confidence is capped"]}, "referenceMaterialId": "coating.painted-metal", "materialFamily": "coating", "materialSubtype": "paint-over-metal", "materialFinish": "gloss-or-satin", "materialReference": {"registry": "/workspace/scratch/d1c5d8f30fba/img2threejs/docs/materials/material-reference.json", "profileId": "coating.painted-metal", "method": "explicit-material-id", "confidence": 1.0, "sourceRefs": ["three.mesh-physical", "gltf.2", "khronos.gltf-pbr", "adobe.pbr-guide-1", "adobe.pbr-guide-2"], "requiredMaps": ["map", "roughnessMap"], "optionalMaps": ["normalMap", "clearcoatMap", "clearcoatRoughnessMap", "metalnessMap"], "validationViews": ["albedo-unlit", "neutral-studio", "grazing", "environment-reflection", "reference-beauty"]}, "textureAnalysis": {"finishClass": "brushed-steel", "recipe": {"metalness": 1.0, "roughness": 0.35, "clearcoat": 0.0, "clearcoatRoughness": 0.0, "transmission": 0.0, "ior": 1.5, "envMapIntensity": 1.0, "anisotropy": 1.0, "procedural": "brushed"}, "palette": ["#161C21", "#A8A9B0", "#DBDAE0", "#D4D3D8", "#BCBAC0"], "paletteHueRisk": [{"stop": "#161C21", "hueRisk": "blue-collapse", "suggestedRgb": [33, 28, 22]}], "gradientAxis": "vertical", "stats": {"meanLum": 179.4, "meanSaturation": 0.082, "gradientStrength": 0.762, "mottle": 0.031, "streakRatio": 0.87, "hueSpread": 0.004, "specularFraction": 0.065}}, "materialEvidence": {"componentId": "deck-shell", "regionId": "shell-white-coating", "crop": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/00-shell-white-coating.png", "bbox": {"x": 0, "y": 0, "width": 300, "height": 88}, "sourceWidth": 300, "sourceHeight": 88, "loaderWarnings": [], "coverage": 1.0}, "observations": ["near-neutral colour response", "strong image-space gradient; verify it is material pattern, not lighting", "single-image PBR inference requires controlled render validation"], "hypothesis": {"componentId": "deck-shell", "regionId": "shell-white-coating", "materialId": "coating.painted-metal", "family": "coating", "subtype": "paint-over-metal", "finish": "gloss-or-satin", "aliases": [], "confidence": 0.829, "source": "approved-reference"}, "alternatives": []}},
    options
  );
  materialMap["graphite"] = createSculptMaterial(
    "graphite",
    {"id": "graphite", "name": "Graphite structural metal", "type": "physical", "shaderModel": "MeshPhysicalMaterial / PBR approximation", "qualityTier": "hero", "baseColor": "#1A222A", "color": "#1A222A", "albedo": {"dominant": "#0F1417", "secondary": ["#181E23", "#07080A", "#6AA8C1"], "samplingNotes": "Reference-derived from foreground pixels; de-lit to reduce baked shadows/highlights.", "map": {"path": "./public/textures/platform/graphite_albedo.png", "url": "/textures/platform/graphite_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}}, "colorVariation": {"palette": ["#0F1417", "#181E23", "#07080A", "#6AA8C1", "#2C4959"], "pattern": "reference-derived pixel palette", "amplitude": 0.182, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2, 2], "anisotropy": 8, "texelDensityIntent": "Stable object-space density; no stretching under runtime platform scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.431, "role": "reference-derived broad albedo and height breakup"}, {"id": "meso", "frequency": 14.0, "amplitude": 0.248, "role": "reference-derived cracks, ridges, pores, grain, or leaf clusters"}, {"id": "micro", "frequency": 72.0, "amplitude": 0.111, "role": "reference-derived micro highlight breakup under grazing light"}], "roughness": {"base": 0.45, "variation": 0.05, "map": {"path": "./public/textures/platform/graphite_roughness.png", "url": "/textures/platform/graphite_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "localResponse": "reference-derived roughness estimate; cavities and textured zones trend rougher, bright highlights trend smoother"}, "metalness": {"base": 0.0, "variation": 0.04}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.184, "map": {"path": "./public/textures/platform/graphite_normal.png", "url": "/textures/platform/graphite_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "heightSource": {"path": "./public/textures/platform/graphite_height.png", "url": "/textures/platform/graphite_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.011, "map": {"path": "./public/textures/platform/graphite_height.png", "url": "/textures/platform/graphite_height.png", "channel": "height", "source": "reference-pixel-extraction"}}, "displacement": {"pattern": "none", "amplitude": 0, "scale": 1, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.38, "contactShadowBias": 0.35, "map": {"path": "./public/textures/platform/graphite_ao.png", "url": "/textures/platform/graphite_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}, "notes": "Reference-derived cavity estimate from local height minima; verify against grazing-light screenshot."}, "wear": {"edgeWear": 0.035, "scratches": [], "chips": []}, "dirt": {"amount": 0.015, "cavityBias": 0.72, "color": "#111820"}, "localOverrides": [{"id": "cassette-cavity", "type": "cavity-darkening", "region": "central underside recess", "baseColor": "#05080B", "roughness": 0.48, "evidenceRefs": ["underside"]}, {"id": "reference-pbr-pixel-evidence", "type": "material-map-evidence", "evidenceRefs": ["full-object"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Use generated maps as material evidence, then refine after browser screenshot comparison."}], "shaderNotes": ["Independent PBR channels come from reference evidence extraction.", "Keep wear restrained and cyan emission localized.", "Reference-derived maps are estimates from image pixels; verify with neutral, grazing, and reference-matched renders.", "Do not treat baked image shadows as final albedo; rerun extraction with a tighter material crop if highlights/shadows pollute the maps."], "notes": "Approved Traversal platform material family.", "finishClass": "candy-coat", "texturePalette": ["#AAA9AD", "#4D5358", "#1D1F21", "#15191B", "#0E1317"], "proceduralTexture": "gradient-smoke", "clearcoat": {"base": 0.75, "variation": 0.0}, "clearcoatRoughness": {"base": 0.12, "variation": 0.0}, "transmission": {"base": 0.0, "variation": 0.0}, "ior": {"base": 1.5, "value": 1.5, "variation": 0.0}, "envMapIntensity": 0.7, "referencePbr": {"version": "1.0", "sourceImage": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/01-graphite-coating.png", "extractor": "stage1_intake/extract_pbr_evidence.py", "method": "single-image pixel evidence with de-lighting estimate; not photogrammetry", "usable": true, "verdict": "pass", "confidence": 0.86, "estimatedFidelity": 0.86, "targetThreshold": 0.7, "hardLimit": "A single image cannot uniquely recover true albedo/roughness/normal/AO; maps are reference-derived estimates.", "maps": {"albedo": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-01-graphite-coating/graphite_albedo.png", "url": "graphite_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-01-graphite-coating/graphite_roughness.png", "url": "graphite_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-01-graphite-coating/graphite_height.png", "url": "graphite_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-01-graphite-coating/graphite_normal.png", "url": "graphite_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-01-graphite-coating/graphite_ao.png", "url": "graphite_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "diagnostics": {"sourceWidth": 260, "sourceHeight": 82, "mapSize": 512, "cropBBoxPixels": {"x": 0, "y": 0, "width": 260, "height": 82}, "mask": {"backgroundColor": "#141519", "backgroundNoise": 166.856, "transparentPixelFraction": 0.0, "foregroundCoverage": 0.4108}, "mapStats": {"valueRange": 0.4299, "heightP90Gradient": 0.04175, "roughnessBase": 0.686, "roughnessVariation": 0.071, "normalStrength": 0.205, "blurRadius": 10}, "palette": ["#0F1417", "#191F23", "#07080A", "#6EAAC2", "#2E4D5D"]}, "warnings": ["single-image inverse rendering cannot prove true physical PBR; confidence is capped"]}, "referenceMaterialId": "coating.painted-metal", "materialFamily": "coating", "materialSubtype": "paint-over-metal", "materialFinish": "gloss-or-satin", "materialReference": {"registry": "/workspace/scratch/d1c5d8f30fba/img2threejs/docs/materials/material-reference.json", "profileId": "coating.painted-metal", "method": "explicit-material-id", "confidence": 1.0, "sourceRefs": ["three.mesh-physical", "gltf.2", "khronos.gltf-pbr", "adobe.pbr-guide-1", "adobe.pbr-guide-2"], "requiredMaps": ["map", "roughnessMap"], "optionalMaps": ["normalMap", "clearcoatMap", "clearcoatRoughnessMap", "metalnessMap"], "validationViews": ["albedo-unlit", "neutral-studio", "grazing", "environment-reflection", "reference-beauty"]}, "textureAnalysis": {"finishClass": "candy-coat", "recipe": {"metalness": 0.35, "roughness": 0.18, "clearcoat": 0.6, "clearcoatRoughness": 0.15, "transmission": 0.0, "ior": 1.5, "envMapIntensity": 0.7, "anisotropy": 0.0, "procedural": "gradient-smoke"}, "palette": ["#AAA9AD", "#4D5358", "#1D1F21", "#15191B", "#0E1317"], "paletteHueRisk": [{"stop": "#15191B", "hueRisk": "blue-collapse", "suggestedRgb": [27, 25, 21]}, {"stop": "#0E1317", "hueRisk": "blue-collapse", "suggestedRgb": [23, 19, 14]}], "gradientAxis": "vertical", "stats": {"meanLum": 57.1, "meanSaturation": 0.193, "gradientStrength": 0.594, "mottle": 0.054, "streakRatio": 1.34, "hueSpread": 0.025, "specularFraction": 0.011}}, "materialEvidence": {"componentId": "undercarriage", "regionId": "graphite-coating", "crop": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/01-graphite-coating.png", "bbox": {"x": 0, "y": 0, "width": 260, "height": 82}, "sourceWidth": 260, "sourceHeight": 82, "loaderWarnings": [], "coverage": 1.0}, "observations": ["chromatic base-colour response", "visible meso/micro variation", "strong image-space gradient; verify it is material pattern, not lighting", "single-image PBR inference requires controlled render validation"], "hypothesis": {"componentId": "undercarriage", "regionId": "graphite-coating", "materialId": "coating.painted-metal", "family": "coating", "subtype": "paint-over-metal", "finish": "gloss-or-satin", "aliases": [], "confidence": 0.86, "source": "approved-reference"}, "alternatives": []}},
    options
  );
  materialMap["emitter-cyan"] = createSculptMaterial(
    "emitter-cyan",
    {"id": "emitter-cyan", "name": "Cyan emitter polymer", "type": "physical", "shaderModel": "MeshPhysicalMaterial / PBR approximation", "qualityTier": "hero", "baseColor": "#5CEFFF", "color": "#5CEFFF", "albedo": {"dominant": "#161C21", "secondary": ["#A1A2A8", "#090A0C", "#E5F3F8"], "samplingNotes": "Reference-derived from foreground pixels; de-lit to reduce baked shadows/highlights.", "map": {"path": "./public/textures/platform/emitter-cyan_albedo.png", "url": "/textures/platform/emitter-cyan_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}}, "colorVariation": {"palette": ["#161C21", "#A1A2A8", "#090A0C", "#E5F3F8", "#536472"], "pattern": "reference-derived pixel palette", "amplitude": 0.241, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2, 2], "anisotropy": 8, "texelDensityIntent": "Stable object-space density; no stretching under runtime platform scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.48, "role": "reference-derived broad albedo and height breakup"}, {"id": "meso", "frequency": 14.0, "amplitude": 0.24, "role": "reference-derived cracks, ridges, pores, grain, or leaf clusters"}, {"id": "micro", "frequency": 72.0, "amplitude": 0.107, "role": "reference-derived micro highlight breakup under grazing light"}], "roughness": {"base": 0.28, "variation": 0.05, "map": {"path": "./public/textures/platform/emitter-cyan_roughness.png", "url": "/textures/platform/emitter-cyan_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "localResponse": "reference-derived roughness estimate; cavities and textured zones trend rougher, bright highlights trend smoother"}, "metalness": {"base": 0.0, "variation": 0.04}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.181, "map": {"path": "./public/textures/platform/emitter-cyan_normal.png", "url": "/textures/platform/emitter-cyan_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "heightSource": {"path": "./public/textures/platform/emitter-cyan_height.png", "url": "/textures/platform/emitter-cyan_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.01, "map": {"path": "./public/textures/platform/emitter-cyan_height.png", "url": "/textures/platform/emitter-cyan_height.png", "channel": "height", "source": "reference-pixel-extraction"}}, "displacement": {"pattern": "none", "amplitude": 0, "scale": 1, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.38, "contactShadowBias": 0.35, "map": {"path": "./public/textures/platform/emitter-cyan_ao.png", "url": "/textures/platform/emitter-cyan_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}, "notes": "Reference-derived cavity estimate from local height minima; verify against grazing-light screenshot."}, "wear": {"edgeWear": 0.035, "scratches": [], "chips": []}, "dirt": {"amount": 0.015, "cavityBias": 0.72, "color": "#111820"}, "localOverrides": [{"id": "front-rail", "type": "emissive", "region": "+Z fascia rails", "emissive": "#18DFFF", "emissiveIntensity": 4.2, "bloom": true, "evidenceRefs": ["front-fascia"]}, {"id": "side-rails", "type": "emissive", "region": "+/-X fascia rails", "emissive": "#18DFFF", "emissiveIntensity": 3.6, "bloom": true, "evidenceRefs": ["full-object"]}, {"id": "reference-pbr-pixel-evidence", "type": "material-map-evidence", "evidenceRefs": ["full-object"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Use generated maps as material evidence, then refine after browser screenshot comparison."}], "shaderNotes": ["Independent PBR channels come from reference evidence extraction.", "Keep wear restrained and cyan emission localized.", "Reference-derived maps are estimates from image pixels; verify with neutral, grazing, and reference-matched renders.", "Do not treat baked image shadows as final albedo; rerun extraction with a tighter material crop if highlights/shadows pollute the maps."], "notes": "Approved Traversal platform material family.", "finishClass": "painted-metal", "texturePalette": ["#9FA2A9", "#6C6C71", "#3B3D41", "#171C20", "#151A1E"], "proceduralTexture": "flat-clearcoat", "clearcoat": {"base": 0.2, "variation": 0.0}, "clearcoatRoughness": {"base": 0.18, "variation": 0.0}, "transmission": {"base": 0.0, "variation": 0.0}, "ior": {"base": 1.5, "value": 1.5, "variation": 0.0}, "envMapIntensity": 1.0, "referencePbr": {"version": "1.0", "sourceImage": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/02-cyan-emitter-lens.png", "extractor": "stage1_intake/extract_pbr_evidence.py", "method": "single-image pixel evidence with de-lighting estimate; not photogrammetry", "usable": true, "verdict": "pass", "confidence": 0.86, "estimatedFidelity": 0.86, "targetThreshold": 0.7, "hardLimit": "A single image cannot uniquely recover true albedo/roughness/normal/AO; maps are reference-derived estimates.", "maps": {"albedo": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-02-cyan-emitter-lens/emitter-cyan_albedo.png", "url": "emitter-cyan_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-02-cyan-emitter-lens/emitter-cyan_roughness.png", "url": "emitter-cyan_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-02-cyan-emitter-lens/emitter-cyan_height.png", "url": "emitter-cyan_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-02-cyan-emitter-lens/emitter-cyan_normal.png", "url": "emitter-cyan_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-02-cyan-emitter-lens/emitter-cyan_ao.png", "url": "emitter-cyan_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "diagnostics": {"sourceWidth": 130, "sourceHeight": 62, "mapSize": 512, "cropBBoxPixels": {"x": 0, "y": 0, "width": 130, "height": 62}, "mask": {"backgroundColor": "#29292B", "backgroundNoise": 61.205, "transparentPixelFraction": 0.0, "foregroundCoverage": 0.7795}, "mapStats": {"valueRange": 0.5729, "heightP90Gradient": 0.04008, "roughnessBase": 0.686, "roughnessVariation": 0.05, "normalStrength": 0.203, "blurRadius": 10}, "palette": ["#171D21", "#A0A2A8", "#111518", "#E7F3F7", "#4E5F6D"]}, "warnings": ["single-image inverse rendering cannot prove true physical PBR; confidence is capped"]}, "referenceMaterialId": "plastic.glossy", "materialFamily": "plastic", "materialSubtype": "generic-polymer", "materialFinish": "glossy", "materialReference": {"registry": "/workspace/scratch/d1c5d8f30fba/img2threejs/docs/materials/material-reference.json", "profileId": "plastic.glossy", "method": "explicit-material-id", "confidence": 1.0, "sourceRefs": ["three.mesh-physical", "three.mesh-standard", "adobe.pbr-guide-1", "google.filament-pbr", "mit.material-recognition"], "requiredMaps": ["map", "roughnessMap"], "optionalMaps": ["normalMap", "clearcoatMap"], "validationViews": ["neutral-studio", "grazing", "environment-reflection", "reference-beauty"]}, "textureAnalysis": {"finishClass": "painted-metal", "recipe": {"metalness": 0.0, "roughness": 0.5, "clearcoat": 1.0, "clearcoatRoughness": 0.05, "transmission": 0.0, "ior": 1.5, "envMapIntensity": 1.0, "anisotropy": 0.0, "procedural": "flat-clearcoat"}, "palette": ["#9FA2A9", "#6C6C71", "#3B3D41", "#171C20", "#151A1E"], "paletteHueRisk": [{"stop": "#171C20", "hueRisk": "blue-collapse", "suggestedRgb": [32, 28, 23]}, {"stop": "#151A1E", "hueRisk": "blue-collapse", "suggestedRgb": [30, 26, 21]}], "gradientAxis": "vertical", "stats": {"meanLum": 72.6, "meanSaturation": 0.184, "gradientStrength": 0.539, "mottle": 0.024, "streakRatio": 1.03, "hueSpread": 0.005, "specularFraction": 0.014}}, "materialEvidence": {"componentId": "emitter-cyan", "regionId": "cyan-emitter-lens", "crop": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/02-cyan-emitter-lens.png", "bbox": {"x": 0, "y": 0, "width": 130, "height": 62}, "sourceWidth": 130, "sourceHeight": 62, "loaderWarnings": [], "coverage": 1.0}, "observations": ["chromatic base-colour response", "strong image-space gradient; verify it is material pattern, not lighting", "single-image PBR inference requires controlled render validation"], "hypothesis": {"componentId": "emitter-cyan", "regionId": "cyan-emitter-lens", "materialId": "plastic.glossy", "family": "plastic", "subtype": "generic-polymer", "finish": "glossy", "aliases": [], "confidence": 0.86, "source": "approved-reference"}, "alternatives": []}},
    options
  );
  materialMap["dark-detail"] = createSculptMaterial(
    "dark-detail",
    {"id": "dark-detail", "name": "Dark machined hardware", "type": "physical", "shaderModel": "MeshPhysicalMaterial / PBR approximation", "qualityTier": "hero", "baseColor": "#414C55", "color": "#414C55", "albedo": {"dominant": "#0E1316", "secondary": ["#07090B", "#D5DAE0", "#28363F"], "samplingNotes": "Reference-derived from foreground pixels; de-lit to reduce baked shadows/highlights.", "map": {"path": "./public/textures/platform/dark-detail_albedo.png", "url": "/textures/platform/dark-detail_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}}, "colorVariation": {"palette": ["#0E1316", "#07090B", "#D5DAE0", "#28363F", "#5892AA"], "pattern": "reference-derived pixel palette", "amplitude": 0.35, "heightCorrelation": 0.42}, "textureResolution": 1024, "textureProjection": {"mode": "uv", "repeat": [2, 2], "anisotropy": 8, "texelDensityIntent": "Stable object-space density; no stretching under runtime platform scale."}, "surfaceFrequencyBands": [{"id": "macro", "frequency": 2.0, "amplitude": 0.52, "role": "reference-derived broad albedo and height breakup"}, {"id": "meso", "frequency": 14.0, "amplitude": 0.215, "role": "reference-derived cracks, ridges, pores, grain, or leaf clusters"}, {"id": "micro", "frequency": 72.0, "amplitude": 0.092, "role": "reference-derived micro highlight breakup under grazing light"}], "roughness": {"base": 0.35, "variation": 0.05, "map": {"path": "./public/textures/platform/dark-detail_roughness.png", "url": "/textures/platform/dark-detail_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "localResponse": "reference-derived roughness estimate; cavities and textured zones trend rougher, bright highlights trend smoother"}, "metalness": {"base": 1.0, "variation": 0.04}, "normal": {"pattern": "reference-derived height-gradient normal map", "strength": 0.174, "map": {"path": "./public/textures/platform/dark-detail_normal.png", "url": "/textures/platform/dark-detail_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "heightSource": {"path": "./public/textures/platform/dark-detail_height.png", "url": "/textures/platform/dark-detail_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "space": "tangent"}, "bump": {"pattern": "reference-derived height field", "amplitude": 0.01, "map": {"path": "./public/textures/platform/dark-detail_height.png", "url": "/textures/platform/dark-detail_height.png", "channel": "height", "source": "reference-pixel-extraction"}}, "displacement": {"pattern": "none", "amplitude": 0, "scale": 1, "silhouetteAffects": false}, "ambientOcclusion": {"cavityStrength": 0.38, "contactShadowBias": 0.35, "map": {"path": "./public/textures/platform/dark-detail_ao.png", "url": "/textures/platform/dark-detail_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}, "notes": "Reference-derived cavity estimate from local height minima; verify against grazing-light screenshot."}, "wear": {"edgeWear": 0.035, "scratches": [], "chips": []}, "dirt": {"amount": 0.015, "cavityBias": 0.72, "color": "#111820"}, "localOverrides": [{"id": "bevel-polish", "type": "roughness", "region": "corner cap and fastener crowns", "roughness": 0.22, "evidenceRefs": ["front-fascia"]}, {"id": "reference-pbr-pixel-evidence", "type": "material-map-evidence", "evidenceRefs": ["full-object"], "channels": ["albedo", "roughness", "height", "normal", "ambient-occlusion"], "notes": "Use generated maps as material evidence, then refine after browser screenshot comparison."}], "shaderNotes": ["Independent PBR channels come from reference evidence extraction.", "Keep wear restrained and cyan emission localized.", "Reference-derived maps are estimates from image pixels; verify with neutral, grazing, and reference-matched renders.", "Do not treat baked image shadows as final albedo; rerun extraction with a tighter material crop if highlights/shadows pollute the maps."], "notes": "Approved Traversal platform material family.", "finishClass": "painted-metal", "texturePalette": ["#9C9EA5", "#5A5C61", "#20282C", "#131619", "#0F1214"], "proceduralTexture": "flat-clearcoat", "clearcoat": {"base": 1.0, "variation": 0.0}, "clearcoatRoughness": {"base": 0.05, "variation": 0.0}, "transmission": {"base": 0.0, "variation": 0.0}, "ior": {"base": 1.5, "value": 1.5}, "envMapIntensity": 1.0, "referencePbr": {"version": "1.0", "sourceImage": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/03-dark-machined-hardware.png", "extractor": "stage1_intake/extract_pbr_evidence.py", "method": "single-image pixel evidence with de-lighting estimate; not photogrammetry", "usable": true, "verdict": "pass", "confidence": 0.86, "estimatedFidelity": 0.86, "targetThreshold": 0.7, "hardLimit": "A single image cannot uniquely recover true albedo/roughness/normal/AO; maps are reference-derived estimates.", "maps": {"albedo": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-03-dark-machined-hardware/dark-detail_albedo.png", "url": "dark-detail_albedo.png", "channel": "albedo", "source": "reference-pixel-extraction"}, "roughness": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-03-dark-machined-hardware/dark-detail_roughness.png", "url": "dark-detail_roughness.png", "channel": "roughness", "source": "reference-pixel-extraction"}, "height": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-03-dark-machined-hardware/dark-detail_height.png", "url": "dark-detail_height.png", "channel": "height", "source": "reference-pixel-extraction"}, "normal": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-03-dark-machined-hardware/dark-detail_normal.png", "url": "dark-detail_normal.png", "channel": "normal", "source": "reference-pixel-extraction"}, "ao": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/pbr-03-dark-machined-hardware/dark-detail_ao.png", "url": "dark-detail_ao.png", "channel": "ao", "source": "reference-pixel-extraction"}}, "diagnostics": {"sourceWidth": 165, "sourceHeight": 74, "mapSize": 512, "cropBBoxPixels": {"x": 0, "y": 0, "width": 165, "height": 74}, "mask": {"backgroundColor": "#0F1315", "backgroundNoise": 99.358, "transparentPixelFraction": 0.0, "foregroundCoverage": 0.4712}, "mapStats": {"valueRange": 0.8753, "heightP90Gradient": 0.02779, "roughnessBase": 0.683, "roughnessVariation": 0.05, "normalStrength": 0.189, "blurRadius": 10}, "palette": ["#0E1316", "#D7DCE2", "#07090B", "#293741", "#558FA8"]}, "warnings": ["single-image inverse rendering cannot prove true physical PBR; confidence is capped"]}, "referenceMaterialId": "metal.steel-brushed", "materialFamily": "metal", "materialSubtype": "steel", "materialFinish": "brushed", "materialReference": {"registry": "/workspace/scratch/d1c5d8f30fba/img2threejs/docs/materials/material-reference.json", "profileId": "metal.steel-brushed", "method": "explicit-material-id", "confidence": 1.0, "sourceRefs": ["three.mesh-physical", "three.pmrem", "gltf.2", "khronos.gltf-pbr", "adobe.pbr-guide-2", "google.filament-pbr"], "requiredMaps": ["map", "roughnessMap", "normalMap", "anisotropyMap"], "optionalMaps": ["metalnessMap"], "validationViews": ["neutral-studio", "grazing", "environment-reflection", "reference-beauty"]}, "anisotropy": {"base": 0.85, "variation": 0.0}, "textureAnalysis": {"finishClass": "painted-metal", "recipe": {"metalness": 0.0, "roughness": 0.5, "clearcoat": 1.0, "clearcoatRoughness": 0.05, "transmission": 0.0, "ior": 1.5, "envMapIntensity": 1.0, "anisotropy": 0.0, "procedural": "flat-clearcoat"}, "palette": ["#9C9EA5", "#5A5C61", "#20282C", "#131619", "#0F1214"], "paletteHueRisk": [{"stop": "#20282C", "hueRisk": "blue-collapse", "suggestedRgb": [44, 40, 32]}, {"stop": "#131619", "hueRisk": "blue-collapse", "suggestedRgb": [25, 22, 19]}, {"stop": "#0F1214", "hueRisk": "blue-collapse", "suggestedRgb": [20, 18, 15]}], "gradientAxis": "vertical", "stats": {"meanLum": 61.7, "meanSaturation": 0.196, "gradientStrength": 0.559, "mottle": 0.031, "streakRatio": 1.04, "hueSpread": 0.01, "specularFraction": 0.02}}, "materialEvidence": {"componentId": "corner-cap-array", "regionId": "dark-machined-hardware", "crop": {"path": "/workspace/scratch/d1c5d8f30fba/Traversal-FPS/docs/art/platform-system/material-region-evidence/03-dark-machined-hardware.png", "bbox": {"x": 0, "y": 0, "width": 165, "height": 74}, "sourceWidth": 165, "sourceHeight": 74, "loaderWarnings": [], "coverage": 1.0}, "observations": ["chromatic base-colour response", "strong image-space gradient; verify it is material pattern, not lighting", "single-image PBR inference requires controlled render validation"], "hypothesis": {"componentId": "corner-cap-array", "regionId": "dark-machined-hardware", "materialId": "metal.steel-brushed", "family": "metal", "subtype": "steel", "finish": "brushed", "aliases": [], "confidence": 0.86, "source": "approved-reference"}, "alternatives": []}, "needsEnvironment": true},
    options
  );
  ...
  destructionGroups["emitter-cyan"].push(node_emitter_cyan_12);
  ...
  node_emitter_cyan_12.add(socket_emitter_cyan_cyan_emission_0);
  sockets["emitter-cyan:cyan-emission"] = socket_emitter_cyan_cyan_emission_0;

  const endpoint_traversal_mark_13 = makeAttachmentEndpoint(null);
  const node_traversal_mark_13 = new THREE.Group();
  node_traversal_mark_13.name = "Triangular Traversal fascia mark__pivot";
  node_traversal_mark_13.scale.set(1, 1, 1);
  if (endpoint_traversal_mark_13) {
    node_traversal_mark_13.position.copy(endpoint_traversal_mark_13.start);
    node_traversal_mark_13.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_traversal_mark_13.position.set(0.0, 0.015, 0.041);
    node_traversal_mark_13.rotation.set(0.0, 0.0, 0.0);
  }
  node_traversal_mark_13.userData.sculptComponent = {"id": "traversal-mark", "name": "Triangular Traversal fascia mark", "level": "micro", "role": "decal", "importance": 0.96, "confidence": 0.94, "primitive": "plane-card", "topologyClass": "material-only", "topologyRationale": "The logo is a flat graphic carrier with no independent structural volume.", "geometryDescriptor": {"topologyIntent": "thin two-sided decal carrier", "edgeTreatment": {"type": "none", "bevelRadius": 0, "segments": 2}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "weighted vertex normals from generated geometry"}, "colorMaterialRecipe": {"dominantAlbedo": "rgba(65, 76, 85, 1)", "secondaryAlbedo": "rgba(12, 17, 22, 1)", "materialClass": "metal", "materialClassConfidence": 0.93, "colorGradient": {"type": "linear", "axis": [0, 1, 0], "stops": [{"position": 0, "color": "rgba(12, 17, 22, 1)"}, {"position": 1, "color": "rgba(65, 76, 85, 1)"}]}}, "parent": "fascia", "attachment": {"parentId": "fascia", "parentSocket": "fascia-surface", "contactType": "overlap", "localStart": [0, 0.015, 0.041], "localEnd": [0, 0.015, 0.041], "contactNormal": [0, 1, 0], "overlap": 0.025, "embedDepth": 0.025, "gapTolerance": 0.01, "evidenceRefs": ["front-fascia"]}, "dimensions": {"width": 0.075, "height": 0.075, "depth": 0.004, "units": "relative", "confidence": 0.94}, "transform": {"position": [0, 0.015, 0.041], "rotation": [0, 0, 0], "scale": [0.075, 0.075, 0.004]}, "actionProfile": {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "traversal-mark", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}}, "material": "dark-detail", "materialLayers": ["dark-detail"], "deformations": [], "joints": [], "seams": [], "localFeatures": ["nested-triangle"], "surfaceDetail": {"macroRoughness": 0.12, "microRoughness": 0.08, "bumpAmplitude": 0.008, "normalPattern": "fine machined-metal variation", "displacementPattern": "none; silhouette relief is geometry", "occlusionPattern": "darken sockets, seams, and chassis overlaps", "edgeWearPattern": "subtle polished bevel crests", "notes": "Keep microstructure below gameplay silhouette scale."}, "evidenceRefs": ["front-fascia"], "details": ["nested-triangle"], "fidelityTier": "surface"};
  node_traversal_mark_13.userData.actionProfile = {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "traversal-mark", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}};
  (nodes["fascia"] ?? root).add(node_traversal_mark_13);
  nodes["traversal-mark"] = node_traversal_mark_13;
  const mesh_traversal_mark_13Geometry = endpoint_traversal_mark_13
    ? new THREE.CylinderGeometry(endpoint_traversal_mark_13.endRadius, endpoint_traversal_mark_13.baseRadius, endpoint_traversal_mark_13.length, 16, 6)
    : new THREE.PlaneGeometry(1, 1, 12, 12);
  if (!endpoint_traversal_mark_13) {
    mesh_traversal_mark_13Geometry.scale(0.075, 0.075, 0.004);
  }
  const mesh_traversal_mark_13 = new THREE.Mesh(
    mesh_traversal_mark_13Geometry,
    materialMap["dark-detail"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_traversal_mark_13.name = "Triangular Traversal fascia mark";
  if (endpoint_traversal_mark_13) {
    mesh_traversal_mark_13.position.copy(endpoint_traversal_mark_13.midpoint);
    mesh_traversal_mark_13.quaternion.copy(endpoint_traversal_mark_13.quaternion);
  }
  mesh_traversal_mark_13.castShadow = options.castShadow ?? true;
  mesh_traversal_mark_13.receiveShadow = options.receiveShadow ?? true;
  mesh_traversal_mark_13.userData.sculptComponent = {"id": "traversal-mark", "name": "Triangular Traversal fascia mark", "level": "micro", "role": "decal", "importance": 0.96, "confidence": 0.94, "primitive": "plane-card", "topologyClass": "material-only", "topologyRationale": "The logo is a flat graphic carrier with no independent structural volume.", "geometryDescriptor": {"topologyIntent": "thin two-sided decal carrier", "edgeTreatment": {"type": "none", "bevelRadius": 0, "segments": 2}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "weighted vertex normals from generated geometry"}, "colorMaterialRecipe": {"dominantAlbedo": "rgba(65, 76, 85, 1)", "secondaryAlbedo": "rgba(12, 17, 22, 1)", "materialClass": "metal", "materialClassConfidence": 0.93, "colorGradient": {"type": "linear", "axis": [0, 1, 0], "stops": [{"position": 0, "color": "rgba(12, 17, 22, 1)"}, {"position": 1, "color": "rgba(65, 76, 85, 1)"}]}}, "parent": "fascia", "attachment": {"parentId": "fascia", "parentSocket": "fascia-surface", "contactType": "overlap", "localStart": [0, 0.015, 0.041], "localEnd": [0, 0.015, 0.041], "contactNormal": [0, 1, 0], "overlap": 0.025, "embedDepth": 0.025, "gapTolerance": 0.01, "evidenceRefs": ["front-fascia"]}, "dimensions": {"width": 0.075, "height": 0.075, "depth": 0.004, "units": "relative", "confidence": 0.94}, "transform": {"position": [0, 0.015, 0.041], "rotation": [0, 0, 0], "scale": [0.075, 0.075, 0.004]}, "actionProfile": {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "traversal-mark", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}}, "material": "dark-detail", "materialLayers": ["dark-detail"], "deformations": [], "joints": [], "seams": [], "localFeatures": ["nested-triangle"], "surfaceDetail": {"macroRoughness": 0.12, "microRoughness": 0.08, "bumpAmplitude": 0.008, "normalPattern": "fine machined-metal variation", "displacementPattern": "none; silhouette relief is geometry", "occlusionPattern": "darken sockets, seams, and chassis overlaps", "edgeWearPattern": "subtle polished bevel crests", "notes": "Keep microstructure below gameplay silhouette scale."}, "evidenceRefs": ["front-fascia"], "details": ["nested-triangle"], "fidelityTier": "surface"};
  node_traversal_mark_13.add(mesh_traversal_mark_13);
  meshes["traversal-mark"] = mesh_traversal_mark_13;
  ...
  destructionGroups["traversal-mark"].push(node_traversal_mark_13);

  const endpoint_emitter_front_left_14 = makeAttachmentEndpoint(null);
  const node_emitter_front_left_14 = new THREE.Group();
  node_emitter_front_left_14.name = "Mirrored front cyan rail__pivot";
  node_emitter_front_left_14.scale.set(1, 1, 1);
  if (endpoint_emitter_front_left_14) {
    node_emitter_front_left_14.position.copy(endpoint_emitter_front_left_14.start);
    node_emitter_front_left_14.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_emitter_front_left_14.position.set(-0.25, -0.04, 0.041);
    node_emitter_front_left_14.rotation.set(0.0, 0.0, 0.0);
  }
  node_emitter_front_left_14.userData.sculptComponent = {"id": "emitter-front-left", "name": "Mirrored front cyan rail", "level": "micro", "role": "effect-emitter", "importance": 0.95, "confidence": 0.94, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "The reference shows a discrete rigid hard-surface part with countable planar faces and manufactured seams.", "geometryDescriptor": {"topologyIntent": "beveled hard-surface game prop", "edgeTreatment": {"type": "chamfer", "bevelRadius": 0.018, "segments": 2}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "weighted vertex normals from generated geometry"}, "colorMaterialRecipe": {"dominantAlbedo": "rgba(92, 239, 255, 1)", "secondaryAlbedo": "rgba(12, 97, 126, 1)", "materialClass": "plastic", "materialClassConfidence": 0.82, "colorGradient": {"type": "linear", "axis": [0, 1, 0], "stops": [{"position": 0, "color": "rgba(12, 97, 126, 1)"}, {"position": 1, "color": "rgba(92, 239, 255, 1)"}]}}, "parent": "fascia", "attachment": {"parentId": "fascia", "parentSocket": "fascia-surface", "contactType": "overlap", "localStart": [-0.25, -0.04, 0.041], "localEnd": [-0.25, -0.04, 0.041], "contactNormal": [0, 1, 0], "overlap": 0.025, "embedDepth": 0.025, "gapTolerance": 0.01, "evidenceRefs": ["front-fascia"]}, "dimensions": {"width": 0.26, "height": 0.032, "depth": 0.018, "units": "relative", "confidence": 0.94}, "transform": {"position": [-0.25, -0.04, 0.041], "rotation": [0, 0, 0], "scale": [0.26, 0.032, 0.018]}, "actionProfile": {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "cyan-emission", "localPosition": [0, 0, 0.012], "localRotation": [0, 0, 0]}], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "emitter-front-left", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}}, "material": "emitter-cyan", "materialLayers": ["emitter-cyan"], "deformations": [], "joints": [], "seams": [], "localFeatures": ["front-rail", "side-rails"], "surfaceDetail": {"macroRoughness": 0.12, "microRoughness": 0.08, "bumpAmplitude": 0.008, "normalPattern": "fine machined-metal variation", "displacementPattern": "none; silhouette relief is geometry", "occlusionPattern": "darken sockets, seams, and chassis overlaps", "edgeWearPattern": "subtle polished bevel crests", "notes": "Keep microstructure below gameplay silhouette scale."}, "evidenceRefs": ["front-fascia"], "details": ["front-rail", "side-rails"], "fidelityTier": "surface"};
  node_emitter_front_left_14.userData.actionProfile = {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "cyan-emission", "localPosition": [0, 0, 0.012], "localRotation": [0, 0, 0]}], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "emitter-front-left", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}};
  (nodes["fascia"] ?? root).add(node_emitter_front_left_14);
  nodes["emitter-front-left"] = node_emitter_front_left_14;
  const mesh_emitter_front_left_14Geometry = endpoint_emitter_front_left_14
    ? new THREE.CylinderGeometry(endpoint_emitter_front_left_14.endRadius, endpoint_emitter_front_left_14.baseRadius, endpoint_emitter_front_left_14.length, 16, 6)
    : new THREE.BoxGeometry(1, 1, 1, 4, 4, 4);
  if (!endpoint_emitter_front_left_14) {
    mesh_emitter_front_left_14Geometry.scale(0.26, 0.032, 0.018);
  }
  const mesh_emitter_front_left_14 = new THREE.Mesh(
    mesh_emitter_front_left_14Geometry,
    materialMap["emitter-cyan"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_emitter_front_left_14.name = "Mirrored front cyan rail";
  if (endpoint_emitter_front_left_14) {
    mesh_emitter_front_left_14.position.copy(endpoint_emitter_front_left_14.midpoint);
    mesh_emitter_front_left_14.quaternion.copy(endpoint_emitter_front_left_14.quaternion);
  }
  mesh_emitter_front_left_14.castShadow = options.castShadow ?? true;
  mesh_emitter_front_left_14.receiveShadow = options.receiveShadow ?? true;
  mesh_emitter_front_left_14.userData.sculptComponent = {"id": "emitter-front-left", "name": "Mirrored front cyan rail", "level": "micro", "role": "effect-emitter", "importance": 0.95, "confidence": 0.94, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "The reference shows a discrete rigid hard-surface part with countable planar faces and manufactured seams.", "geometryDescriptor": {"topologyIntent": "beveled hard-surface game prop", "edgeTreatment": {"type": "chamfer", "bevelRadius": 0.018, "segments": 2}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "weighted vertex normals from generated geometry"}, "colorMaterialRecipe": {"dominantAlbedo": "rgba(92, 239, 255, 1)", "secondaryAlbedo": "rgba(12, 97, 126, 1)", "materialClass": "plastic", "materialClassConfidence": 0.82, "colorGradient": {"type": "linear", "axis": [0, 1, 0], "stops": [{"position": 0, "color": "rgba(12, 97, 126, 1)"}, {"position": 1, "color": "rgba(92, 239, 255, 1)"}]}}, "parent": "fascia", "attachment": {"parentId": "fascia", "parentSocket": "fascia-surface", "contactType": "overlap", "localStart": [-0.25, -0.04, 0.041], "localEnd": [-0.25, -0.04, 0.041], "contactNormal": [0, 1, 0], "overlap": 0.025, "embedDepth": 0.025, "gapTolerance": 0.01, "evidenceRefs": ["front-fascia"]}, "dimensions": {"width": 0.26, "height": 0.032, "depth": 0.018, "units": "relative", "confidence": 0.94}, "transform": {"position": [-0.25, -0.04, 0.041], "rotation": [0, 0, 0], "scale": [0.26, 0.032, 0.018]}, "actionProfile": {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "cyan-emission", "localPosition": [0, 0, 0.012], "localRotation": [0, 0, 0]}], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "emitter-front-left", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}}, "material": "emitter-cyan", "materialLayers": ["emitter-cyan"], "deformations": [], "joints": [], "seams": [], "localFeatures": ["front-rail", "side-rails"], "surfaceDetail": {"macroRoughness": 0.12, "microRoughness": 0.08, "bumpAmplitude": 0.008, "normalPattern": "fine machined-metal variation", "displacementPattern": "none; silhouette relief is geometry", "occlusionPattern": "darken sockets, seams, and chassis overlaps", "edgeWearPattern": "subtle polished bevel crests", "notes": "Keep microstructure below gameplay silhouette scale."}, "evidenceRefs": ["front-fascia"], "details": ["front-rail", "side-rails"], "fidelityTier": "surface"};
  node_emitter_front_left_14.add(mesh_emitter_front_left_14);
  meshes["emitter-front-left"] = mesh_emitter_front_left_14;
  colliders["emitter-front-left"] = {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."};
  destructionGroups["emitter-front-left"] ??= [];
  destructionGroups["emitter-front-left"].push(node_emitter_front_left_14);
  const socket_emitter_front_left_cyan_emission_0 = new THREE.Object3D();
  socket_emitter_front_left_cyan_emission_0.name = "cyan-emission";
  socket_emitter_front_left_cyan_emission_0.position.set(0.0, 0.0, 0.012);
  socket_emitter_front_left_cyan_emission_0.rotation.set(0.0, 0.0, 0.0);
  socket_emitter_front_left_cyan_emission_0.userData.socket = {"id": "cyan-emission", "localPosition": [0, 0, 0.012], "localRotation": [0, 0, 0]};
  node_emitter_front_left_14.add(socket_emitter_front_left_cyan_emission_0);
  sockets["emitter-front-left:cyan-emission"] = socket_emitter_front_left_cyan_emission_0;

  const endpoint_emitter_left_side_15 = makeAttachmentEndpoint(null);
  const node_emitter_left_side_15 = new THREE.Group();
  node_emitter_left_side_15.name = "Left lateral cyan rail__pivot";
  node_emitter_left_side_15.scale.set(1, 1, 1);
  if (endpoint_emitter_left_side_15) {
    node_emitter_left_side_15.position.copy(endpoint_emitter_left_side_15.start);
    node_emitter_left_side_15.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_emitter_left_side_15.position.set(-0.041, -0.04, 0.23);
    node_emitter_left_side_15.rotation.set(0.0, 0.0, 0.0);
  }
  node_emitter_left_side_15.userData.sculptComponent = {"id": "emitter-left-side", "name": "Left lateral cyan rail", "level": "micro", "role": "effect-emitter", "importance": 0.95, "confidence": 0.94, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "The reference shows a discrete rigid hard-surface part with countable planar faces and manufactured seams.", "geometryDescriptor": {"topologyIntent": "beveled hard-surface game prop", "edgeTreatment": {"type": "chamfer", "bevelRadius": 0.018, "segments": 2}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "weighted vertex normals from generated geometry"}, "colorMaterialRecipe": {"dominantAlbedo": "rgba(92, 239, 255, 1)", "secondaryAlbedo": "rgba(12, 97, 126, 1)", "materialClass": "plastic", "materialClassConfidence": 0.82, "colorGradient": {"type": "linear", "axis": [0, 1, 0], "stops": [{"position": 0, "color": "rgba(12, 97, 126, 1)"}, {"position": 1, "color": "rgba(92, 239, 255, 1)"}]}}, "parent": "left-fascia", "attachment": {"parentId": "left-fascia", "parentSocket": "left-fascia-surface", "contactType": "overlap", "localStart": [-0.041, -0.04, 0.23], "localEnd": [-0.041, -0.04, 0.23], "contactNormal": [-1, 0, 0], "overlap": 0.025, "embedDepth": 0.025, "gapTolerance": 0.01, "evidenceRefs": ["front-fascia"]}, "dimensions": {"width": 0.018, "height": 0.032, "depth": 0.26, "units": "relative", "confidence": 0.94}, "transform": {"position": [-0.041, -0.04, 0.23], "rotation": [0, 0, 0], "scale": [0.018, 0.032, 0.26]}, "actionProfile": {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "cyan-emission", "localPosition": [0, 0, 0.012], "localRotation": [0, 0, 0]}], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "emitter-left-side", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}}, "material": "emitter-cyan", "materialLayers": ["emitter-cyan"], "deformations": [], "joints": [], "seams": [], "localFeatures": ["front-rail", "side-rails"], "surfaceDetail": {"macroRoughness": 0.12, "microRoughness": 0.08, "bumpAmplitude": 0.008, "normalPattern": "fine machined-metal variation", "displacementPattern": "none; silhouette relief is geometry", "occlusionPattern": "darken sockets, seams, and chassis overlaps", "edgeWearPattern": "subtle polished bevel crests", "notes": "Keep microstructure below gameplay silhouette scale."}, "evidenceRefs": ["front-fascia"], "details": ["front-rail", "side-rails"], "fidelityTier": "surface"};
  node_emitter_left_side_15.userData.actionProfile = {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "cyan-emission", "localPosition": [0, 0, 0.012], "localRotation": [0, 0, 0]}], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "emitter-left-side", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}};
  (nodes["left-fascia"] ?? root).add(node_emitter_left_side_15);
  nodes["emitter-left-side"] = node_emitter_left_side_15;
  const mesh_emitter_left_side_15Geometry = endpoint_emitter_left_side_15
    ? new THREE.CylinderGeometry(endpoint_emitter_left_side_15.endRadius, endpoint_emitter_left_side_15.baseRadius, endpoint_emitter_left_side_15.length, 16, 6)
    : new THREE.BoxGeometry(1, 1, 1, 4, 4, 4);
  if (!endpoint_emitter_left_side_15) {
    mesh_emitter_left_side_15Geometry.scale(0.018, 0.032, 0.26);
  }
  const mesh_emitter_left_side_15 = new THREE.Mesh(
    mesh_emitter_left_side_15Geometry,
    materialMap["emitter-cyan"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_emitter_left_side_15.name = "Left lateral cyan rail";
  if (endpoint_emitter_left_side_15) {
    mesh_emitter_left_side_15.position.copy(endpoint_emitter_left_side_15.midpoint);
    mesh_emitter_left_side_15.quaternion.copy(endpoint_emitter_left_side_15.quaternion);
  }
  mesh_emitter_left_side_15.castShadow = options.castShadow ?? true;
  mesh_emitter_left_side_15.receiveShadow = options.receiveShadow ?? true;
  mesh_emitter_left_side_15.userData.sculptComponent = {"id": "emitter-left-side", "name": "Left lateral cyan rail", "level": "micro", "role": "effect-emitter", "importance": 0.95, "confidence": 0.94, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "The reference shows a discrete rigid hard-surface part with countable planar faces and manufactured seams.", "geometryDescriptor": {"topologyIntent": "beveled hard-surface game prop", "edgeTreatment": {"type": "chamfer", "bevelRadius": 0.018, "segments": 2}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "weighted vertex normals from generated geometry"}, "colorMaterialRecipe": {"dominantAlbedo": "rgba(92, 239, 255, 1)", "secondaryAlbedo": "rgba(12, 97, 126, 1)", "materialClass": "plastic", "materialClassConfidence": 0.82, "colorGradient": {"type": "linear", "axis": [0, 1, 0], "stops": [{"position": 0, "color": "rgba(12, 97, 126, 1)"}, {"position": 1, "color": "rgba(92, 239, 255, 1)"}]}}, "parent": "left-fascia", "attachment": {"parentId": "left-fascia", "parentSocket": "left-fascia-surface", "contactType": "overlap", "localStart": [-0.041, -0.04, 0.23], "localEnd": [-0.041, -0.04, 0.23], "contactNormal": [-1, 0, 0], "overlap": 0.025, "embedDepth": 0.025, "gapTolerance": 0.01, "evidenceRefs": ["front-fascia"]}, "dimensions": {"width": 0.018, "height": 0.032, "depth": 0.26, "units": "relative", "confidence": 0.94}, "transform": {"position": [-0.041, -0.04, 0.23], "rotation": [0, 0, 0], "scale": [0.018, 0.032, 0.26]}, "actionProfile": {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "cyan-emission", "localPosition": [0, 0, 0.012], "localRotation": [0, 0, 0]}], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "emitter-left-side", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}}, "material": "emitter-cyan", "materialLayers": ["emitter-cyan"], "deformations": [], "joints": [], "seams": [], "localFeatures": ["front-rail", "side-rails"], "surfaceDetail": {"macroRoughness": 0.12, "microRoughness": 0.08, "bumpAmplitude": 0.008, "normalPattern": "fine machined-metal variation", "displacementPattern": "none; silhouette relief is geometry", "occlusionPattern": "darken sockets, seams, and chassis overlaps", "edgeWearPattern": "subtle polished bevel crests", "notes": "Keep microstructure below gameplay silhouette scale."}, "evidenceRefs": ["front-fascia"], "details": ["front-rail", "side-rails"], "fidelityTier": "surface"};
  node_emitter_left_side_15.add(mesh_emitter_left_side_15);
  meshes["emitter-left-side"] = mesh_emitter_left_side_15;
  colliders["emitter-left-side"] = {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."};
  destructionGroups["emitter-left-side"] ??= [];
  destructionGroups["emitter-left-side"].push(node_emitter_left_side_15);
  const socket_emitter_left_side_cyan_emission_0 = new THREE.Object3D();
  socket_emitter_left_side_cyan_emission_0.name = "cyan-emission";
  socket_emitter_left_side_cyan_emission_0.position.set(0.0, 0.0, 0.012);
  socket_emitter_left_side_cyan_emission_0.rotation.set(0.0, 0.0, 0.0);
  socket_emitter_left_side_cyan_emission_0.userData.socket = {"id": "cyan-emission", "localPosition": [0, 0, 0.012], "localRotation": [0, 0, 0]};
  node_emitter_left_side_15.add(socket_emitter_left_side_cyan_emission_0);
  sockets["emitter-left-side:cyan-emission"] = socket_emitter_left_side_cyan_emission_0;

  const endpoint_emitter_right_side_16 = makeAttachmentEndpoint(null);
  const node_emitter_right_side_16 = new THREE.Group();
  node_emitter_right_side_16.name = "Right lateral cyan rail__pivot";
  node_emitter_right_side_16.scale.set(1, 1, 1);
  if (endpoint_emitter_right_side_16) {
    node_emitter_right_side_16.position.copy(endpoint_emitter_right_side_16.start);
    node_emitter_right_side_16.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_emitter_right_side_16.position.set(0.041, -0.04, -0.23);
    node_emitter_right_side_16.rotation.set(0.0, 0.0, 0.0);
  }
  node_emitter_right_side_16.userData.sculptComponent = {"id": "emitter-right-side", "name": "Right lateral cyan rail", "level": "micro", "role": "effect-emitter", "importance": 0.95, "confidence": 0.94, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "The reference shows a discrete rigid hard-surface part with countable planar faces and manufactured seams.", "geometryDescriptor": {"topologyIntent": "beveled hard-surface game prop", "edgeTreatment": {"type": "chamfer", "bevelRadius": 0.018, "segments": 2}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "weighted vertex normals from generated geometry"}, "colorMaterialRecipe": {"dominantAlbedo": "rgba(92, 239, 255, 1)", "secondaryAlbedo": "rgba(12, 97, 126, 1)", "materialClass": "plastic", "materialClassConfidence": 0.82, "colorGradient": {"type": "linear", "axis": [0, 1, 0], "stops": [{"position": 0, "color": "rgba(12, 97, 126, 1)"}, {"position": 1, "color": "rgba(92, 239, 255, 1)"}]}}, "parent": "right-fascia", "attachment": {"parentId": "right-fascia", "parentSocket": "right-fascia-surface", "contactType": "overlap", "localStart": [0.041, -0.04, -0.23], "localEnd": [0.041, -0.04, -0.23], "contactNormal": [1, 0, 0], "overlap": 0.025, "embedDepth": 0.025, "gapTolerance": 0.01, "evidenceRefs": ["front-fascia"]}, "dimensions": {"width": 0.018, "height": 0.032, "depth": 0.26, "units": "relative", "confidence": 0.94}, "transform": {"position": [0.041, -0.04, -0.23], "rotation": [0, 0, 0], "scale": [0.018, 0.032, 0.26]}, "actionProfile": {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "cyan-emission", "localPosition": [0, 0, 0.012], "localRotation": [0, 0, 0]}], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "emitter-right-side", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}}, "material": "emitter-cyan", "materialLayers": ["emitter-cyan"], "deformations": [], "joints": [], "seams": [], "localFeatures": ["front-rail", "side-rails"], "surfaceDetail": {"macroRoughness": 0.12, "microRoughness": 0.08, "bumpAmplitude": 0.008, "normalPattern": "fine machined-metal variation", "displacementPattern": "none; silhouette relief is geometry", "occlusionPattern": "darken sockets, seams, and chassis overlaps", "edgeWearPattern": "subtle polished bevel crests", "notes": "Keep microstructure below gameplay silhouette scale."}, "evidenceRefs": ["front-fascia"], "details": ["front-rail", "side-rails"], "fidelityTier": "surface"};
  node_emitter_right_side_16.userData.actionProfile = {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "cyan-emission", "localPosition": [0, 0, 0.012], "localRotation": [0, 0, 0]}], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "emitter-right-side", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}};
  (nodes["right-fascia"] ?? root).add(node_emitter_right_side_16);
  nodes["emitter-right-side"] = node_emitter_right_side_16;
  const mesh_emitter_right_side_16Geometry = endpoint_emitter_right_side_16
    ? new THREE.CylinderGeometry(endpoint_emitter_right_side_16.endRadius, endpoint_emitter_right_side_16.baseRadius, endpoint_emitter_right_side_16.length, 16, 6)
    : new THREE.BoxGeometry(1, 1, 1, 4, 4, 4);
  if (!endpoint_emitter_right_side_16) {
    mesh_emitter_right_side_16Geometry.scale(0.018, 0.032, 0.26);
  }
  const mesh_emitter_right_side_16 = new THREE.Mesh(
    mesh_emitter_right_side_16Geometry,
    materialMap["emitter-cyan"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_emitter_right_side_16.name = "Right lateral cyan rail";
  if (endpoint_emitter_right_side_16) {
    mesh_emitter_right_side_16.position.copy(endpoint_emitter_right_side_16.midpoint);
    mesh_emitter_right_side_16.quaternion.copy(endpoint_emitter_right_side_16.quaternion);
  }
  mesh_emitter_right_side_16.castShadow = options.castShadow ?? true;
  mesh_emitter_right_side_16.receiveShadow = options.receiveShadow ?? true;
  mesh_emitter_right_side_16.userData.sculptComponent = {"id": "emitter-right-side", "name": "Right lateral cyan rail", "level": "micro", "role": "effect-emitter", "importance": 0.95, "confidence": 0.94, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "The reference shows a discrete rigid hard-surface part with countable planar faces and manufactured seams.", "geometryDescriptor": {"topologyIntent": "beveled hard-surface game prop", "edgeTreatment": {"type": "chamfer", "bevelRadius": 0.018, "segments": 2}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "weighted vertex normals from generated geometry"}, "colorMaterialRecipe": {"dominantAlbedo": "rgba(92, 239, 255, 1)", "secondaryAlbedo": "rgba(12, 97, 126, 1)", "materialClass": "plastic", "materialClassConfidence": 0.82, "colorGradient": {"type": "linear", "axis": [0, 1, 0], "stops": [{"position": 0, "color": "rgba(12, 97, 126, 1)"}, {"position": 1, "color": "rgba(92, 239, 255, 1)"}]}}, "parent": "right-fascia", "attachment": {"parentId": "right-fascia", "parentSocket": "right-fascia-surface", "contactType": "overlap", "localStart": [0.041, -0.04, -0.23], "localEnd": [0.041, -0.04, -0.23], "contactNormal": [1, 0, 0], "overlap": 0.025, "embedDepth": 0.025, "gapTolerance": 0.01, "evidenceRefs": ["front-fascia"]}, "dimensions": {"width": 0.018, "height": 0.032, "depth": 0.26, "units": "relative", "confidence": 0.94}, "transform": {"position": [0.041, -0.04, -0.23], "rotation": [0, 0, 0], "scale": [0.018, 0.032, 0.26]}, "actionProfile": {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [{"id": "cyan-emission", "localPosition": [0, 0, 0.012], "localRotation": [0, 0, 0]}], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "emitter-right-side", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}}, "material": "emitter-cyan", "materialLayers": ["emitter-cyan"], "deformations": [], "joints": [], "seams": [], "localFeatures": ["front-rail", "side-rails"], "surfaceDetail": {"macroRoughness": 0.12, "microRoughness": 0.08, "bumpAmplitude": 0.008, "normalPattern": "fine machined-metal variation", "displacementPattern": "none; silhouette relief is geometry", "occlusionPattern": "darken sockets, seams, and chassis overlaps", "edgeWearPattern": "subtle polished bevel crests", "notes": "Keep microstructure below gameplay silhouette scale."}, "evidenceRefs": ["front-fascia"], "details": ["front-rail", "side-rails"], "fidelityTier": "surface"};
  node_emitter_right_side_16.add(mesh_emitter_right_side_16);
  meshes["emitter-right-side"] = mesh_emitter_right_side_16;
  colliders["emitter-right-side"] = {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."};
  destructionGroups["emitter-right-side"] ??= [];
  destructionGroups["emitter-right-side"].push(node_emitter_right_side_16);
  const socket_emitter_right_side_cyan_emission_0 = new THREE.Object3D();
  socket_emitter_right_side_cyan_emission_0.name = "cyan-emission";
  socket_emitter_right_side_cyan_emission_0.position.set(0.0, 0.0, 0.012);
  socket_emitter_right_side_cyan_emission_0.rotation.set(0.0, 0.0, 0.0);
  socket_emitter_right_side_cyan_emission_0.userData.socket = {"id": "cyan-emission", "localPosition": [0, 0, 0.012], "localRotation": [0, 0, 0]};
  node_emitter_right_side_16.add(socket_emitter_right_side_cyan_emission_0);
  sockets["emitter-right-side:cyan-emission"] = socket_emitter_right_side_cyan_emission_0;
