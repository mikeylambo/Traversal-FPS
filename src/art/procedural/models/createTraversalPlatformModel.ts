...
export function createTraversalMovingPlatformModel(options: ProceduralModelOptions = {}): THREE.Group {
  ...
  const mesh_deck_shell_1Geometry = endpoint_deck_shell_1
    ...
    : new THREE.BoxGeometry(1, 1, 1, 4, 4, 4);
  if (!endpoint_deck_shell_1) {
    mesh_deck_shell_1Geometry.scale(1.0, 1.0, 1.0);
  }
  ...
  const mesh_undercarriage_2Geometry = endpoint_undercarriage_2
    ...
    : new THREE.BoxGeometry(1, 1, 1, 4, 4, 4);
  if (!endpoint_undercarriage_2) {
    mesh_undercarriage_2Geometry.scale(1.0, 1.0, 1.0);
  }
  ...
  const endpoint_central_cassette_3 = makeAttachmentEndpoint(null);
  const node_central_cassette_3 = new THREE.Group();
  node_central_cassette_3.name = "Central underside cassette__pivot";
  node_central_cassette_3.scale.set(1, 1, 1);
  if (endpoint_central_cassette_3) {
    node_central_cassette_3.position.copy(endpoint_central_cassette_3.start);
    node_central_cassette_3.rotation.set(0.0, 0.0, 0.0);
  } else {
    node_central_cassette_3.position.set(0.0, 0.015, 0.02);
    node_central_cassette_3.rotation.set(0.0, 0.0, 0.0);
  }
  node_central_cassette_3.userData.sculptComponent = {"id": "central-cassette", "name": "Central underside cassette", "level": "meso", "role": "support", "importance": 0.82, "confidence": 0.84, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "The reference shows a discrete rigid hard-surface part with countable planar faces and manufactured seams.", "geometryDescriptor": {"topologyIntent": "beveled hard-surface game prop", "edgeTreatment": {"type": "chamfer", "bevelRadius": 0.018, "segments": 2}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "weighted vertex normals from generated geometry"}, "colorMaterialRecipe": {"dominantAlbedo": "rgba(26, 34, 42, 1)", "secondaryAlbedo": "rgba(7, 12, 17, 1)", "materialClass": "metal", "materialClassConfidence": 0.94, "colorGradient": {"type": "linear", "axis": [0, 1, 0], "stops": [{"position": 0, "color": "rgba(7, 12, 17, 1)"}, {"position": 1, "color": "rgba(26, 34, 42, 1)"}]}}, "parent": "undercarriage", "attachment": {"parentId": "undercarriage", "parentSocket": "undercarriage-surface", "contactType": "overlap", "localStart": [0, 0.015, 0.02], "localEnd": [0, 0.015, 0.02], "contactNormal": [0, 1, 0], "overlap": 0.025, "embedDepth": 0.025, "gapTolerance": 0.01, "evidenceRefs": ["underside"]}, "dimensions": {"width": 0.38, "height": 0.23, "depth": 0.42, "units": "relative", "confidence": 0.94}, "transform": {"position": [0, 0.015, 0.02], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "central-cassette", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}}, "material": "graphite", "materialLayers": ["graphite"], "deformations": [], "joints": [], "seams": [], "localFeatures": ["cassette-recess", "cassette-frame"], "surfaceDetail": {"macroRoughness": 0.12, "microRoughness": 0.08, "bumpAmplitude": 0.008, "normalPattern": "fine machined-metal variation", "displacementPattern": "none; silhouette relief is geometry", "occlusionPattern": "darken sockets, seams, and chassis overlaps", "edgeWearPattern": "subtle polished bevel crests", "notes": "Keep microstructure below gameplay silhouette scale."}, "evidenceRefs": ["underside"], "details": ["cassette-recess", "cassette-frame"], "fidelityTier": "structural"};
  node_central_cassette_3.userData.actionProfile = {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "central-cassette", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}};
  (nodes["undercarriage"] ?? root).add(node_central_cassette_3);
  nodes["central-cassette"] = node_central_cassette_3;
  const mesh_central_cassette_3Geometry = endpoint_central_cassette_3
    ? new THREE.CylinderGeometry(endpoint_central_cassette_3.endRadius, endpoint_central_cassette_3.baseRadius, endpoint_central_cassette_3.length, 16, 6)
    : new THREE.BoxGeometry(1, 1, 1, 4, 4, 4);
  if (!endpoint_central_cassette_3) {
    mesh_central_cassette_3Geometry.scale(1.0, 1.0, 1.0);
  }
  const mesh_central_cassette_3 = new THREE.Mesh(
    mesh_central_cassette_3Geometry,
    materialMap["graphite"] ?? new THREE.MeshStandardMaterial({ color: 0x888888 })
  );
  mesh_central_cassette_3.name = "Central underside cassette";
  if (endpoint_central_cassette_3) {
    mesh_central_cassette_3.position.copy(endpoint_central_cassette_3.midpoint);
    mesh_central_cassette_3.quaternion.copy(endpoint_central_cassette_3.quaternion);
  }
  mesh_central_cassette_3.castShadow = options.castShadow ?? true;
  mesh_central_cassette_3.receiveShadow = options.receiveShadow ?? true;
  mesh_central_cassette_3.userData.sculptComponent = {"id": "central-cassette", "name": "Central underside cassette", "level": "meso", "role": "support", "importance": 0.82, "confidence": 0.84, "primitive": "box", "topologyClass": "assembled-solid", "topologyRationale": "The reference shows a discrete rigid hard-surface part with countable planar faces and manufactured seams.", "geometryDescriptor": {"topologyIntent": "beveled hard-surface game prop", "edgeTreatment": {"type": "chamfer", "bevelRadius": 0.018, "segments": 2}, "deformationStack": [], "uvStrategy": "generated procedural coordinates", "normalStrategy": "weighted vertex normals from generated geometry"}, "colorMaterialRecipe": {"dominantAlbedo": "rgba(26, 34, 42, 1)", "secondaryAlbedo": "rgba(7, 12, 17, 1)", "materialClass": "metal", "materialClassConfidence": 0.94, "colorGradient": {"type": "linear", "axis": [0, 1, 0], "stops": [{"position": 0, "color": "rgba(7, 12, 17, 1)"}, {"position": 1, "color": "rgba(26, 34, 42, 1)"}]}}, "parent": "undercarriage", "attachment": {"parentId": "undercarriage", "parentSocket": "undercarriage-surface", "contactType": "overlap", "localStart": [0, 0.015, 0.02], "localEnd": [0, 0.015, 0.02], "contactNormal": [0, 1, 0], "overlap": 0.025, "embedDepth": 0.025, "gapTolerance": 0.01, "evidenceRefs": ["underside"]}, "dimensions": {"width": 0.38, "height": 0.23, "depth": 0.42, "units": "relative", "confidence": 0.94}, "transform": {"position": [0, 0.015, 0.02], "rotation": [0, 0, 0], "scale": [1, 1, 1]}, "actionProfile": {"animationRole": "static-presentation", "pivot": {"mode": "center", "localPosition": [0, 0, 0], "axis": [0, 1, 0], "confidence": 0.95}, "transformChannels": {"translate": true, "rotate": false, "scale": false, "bend": false, "twist": false, "detach": false, "visibility": true, "materialState": true}, "sockets": [], "collider": {"type": "none", "offset": [0, 0, 0], "scale": [1, 1, 1], "isTrigger": true, "notes": "Presentation-only; authoritative collision remains on the parent gameplay mesh."}, "constraints": [], "destruction": {"breakable": false, "fractureGroup": "central-cassette", "seamRefs": [], "detachableFragments": [], "breakImpulse": 0, "debrisMaterial": "graphite"}}, "material": "graphite", "materialLayers": ["graphite"], "deformations": [], "joints": [], "seams": [], "localFeatures": ["cassette-recess", "cassette-frame"], "surfaceDetail": {"macroRoughness": 0.12, "microRoughness": 0.08, "bumpAmplitude": 0.008, "normalPattern": "fine machined-metal variation", "displacementPattern": "none; silhouette relief is geometry", "occlusionPattern": "darken sockets, seams, and chassis overlaps", "edgeWearPattern": "subtle polished bevel crests", "notes": "Keep microstructure below gameplay silhouette scale."}, "evidenceRefs": ["underside"], "details": ["cassette-recess", "cassette-frame"], "fidelityTier": "structural"};
  node_central_cassette_3.add(mesh_central_cassette_3);
  meshes["central-cassette"] = mesh_central_cassette_3;
  ...
  destructionGroups["central-cassette"].push(node_central_cassette_3);
